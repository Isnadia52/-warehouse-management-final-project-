    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-electric-cyan leading-tight">
            <div id="product-header-target" 
                 class="typing-target" 
                 data-text="{{ __('ADD NEW QUANTUM PRODUCT') }}" 
            ...
            <form method="POST" action="{{ route(auth()->user()->role . '.products.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="sku" name="sku" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" :value="old('sku')" required />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="unit" name="unit" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" :value="old('unit')" required />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <x-text-input id="buy_price" name="buy_price" type="number" step="0.01" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" :value="old('buy_price')" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="sell_price" name="sell_price" type="number" step="0.01" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" :value="old('sell_price')" required />
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <x-text-input id="current_stock" name="current_stock" type="number" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" :value="old('current_stock')" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="min_stock" name="min_stock" type="number" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" :value="old('min_stock')" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="rack_location" name="rack_location" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 text-white" :value="old('rack_location')" />
